...
class Admin::CompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_company" do
    assert_difference("Admin::Company.count") do
      post admin_companies_url, params: { admin_company: { address: @admin_company.address, name: @admin_company.name } }
    end
  ...
  test "should update admin_company" do
    patch admin_company_url(@admin_company), params: { admin_company: { address: @admin_company.address, name: @admin_company.name } }
